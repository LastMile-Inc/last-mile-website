export const products = [
  {
    ...
    shortTitle: "Observe.",
    copy: "Consumes configured operational evidence, preserves source authority, and qualifies what is current, valid, duplicated, replayed, or unresolved.",
    input: "Configured telemetry, events, alarms, equipment state, and source metadata",
    responsibility: "Source evidence, time, quality, duplication, replay, mapping, and canonical-record production",
    output: "SSOM-conformant canonical operational records with provenance and source references",
  ...
  },
  {
    ...
    copy: "Establishes canonical identity, topology, Conditions, evidence, time, and verified Outcomes across systems.",
  ...
  },
  {
    ...
    name: "Infinit-Flow",
    route: "/infinit-flow",
    shortTitle: "Decide + Coordinate + Act.",
    copy: "Acts as the operational decision and orchestration engine across cases, work, approvals, escalation, providers, and policy-governed AUTO/ASSIST action.",
