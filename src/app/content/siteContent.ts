export const products = [
  {
    ...
    shortTitle: "Observe + qualify.",
    copy: "Qualifies source evidence, preserves source authority, and decides what is trustworthy enough to enter the accountable response.",
    input: "Configured telemetry, events, alarms, equipment state, and source metadata",
    responsibility: "Evidence intake, time, quality, duplication, replay, mapping, and canonical-record production",
    output: "Qualified canonical operational records with provenance and source references for Singularity",
  ...
  },
  {
    ...
    name: "Singularity",
    route: "/singularity",
    shortTitle: "Understand + connect.",
    copy: "Creates the shared operational memory that binds identity, topology, evidence, Conditions, and Outcomes into one accountable case.",
    input: "Trusted records with source identity, timing, quality, and asset references",
    responsibility: "Canonical identity, relationships, topology, Conditions, Outcomes, history, uncertainty, and semantic lineage",
  ...
  },
  {
    ...
    name: "Infinit-Flow",
    route: "/infinit-flow",
    shortTitle: "Orchestrate + execute.",
    copy: "Acts as the orchestration engine across cases, work, approvals, escalation, providers, and policy-governed AUTO/ASSIST action.",
  ...
  },
  {
    ...
    copy: "Keeps the live state, ownership, evidence, work, authority, and verified outcome visible to every role in the response.",
...
export const ecosystemFamilies = [
  { title: "Industrial data and brokers", examples: "MQTT, Sparkplug, OPC UA, and configured UNS subscriptions", maturity: "Reference Architecture" },
