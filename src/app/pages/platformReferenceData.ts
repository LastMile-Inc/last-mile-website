...
export type OperatingScenario = {
  ...
  processMap: { src: string; alt: string };
...
export const operatingScenarios: Record<OperatingScenarioKey, OperatingScenario> = {
  cooling: {
    ...
    thesis: "Cooling redundancy, verified. One accountable cooling event—from first evidence to proven restoration of protection.",
    ...
    response: [
      ...
      { stage: "Verify", product: "Singularity + Infinit-Control", mode: "AUTO", detail: "Evaluate current valid pump, current, pressure, temperature, and stability measurements independently of SAP closure." },
    ],
    ...
    processMap: { src: "/images/reference/data-center-cooling-condition-to-outcome.png", alt: "Data center cooling condition-to-outcome map connecting chilled-water pump evidence, qualification, coordinated work, human authority, and telemetry-established recovery" },
  ...
  wastewater: {
    ...
    thesis: "Stop the overflow before it starts. One accountable station event—from developing impairment to verified pumping capacity.",
    ...
    response: [
      ...
      { stage: "Verify", product: "Singularity + Infinit-Control", mode: "AUTO", detail: "Require restored drawdown across three complete cycles, current and flow in band, no high-high event, and valid data." },
    ],
    ...
    processMap: { src: "/images/reference/municipal-wastewater-condition-to-outcome.png", alt: "Municipal wastewater condition-to-outcome map connecting wet-well and pump evidence to field response and verified drawdown capacity" },
  ...
  air: {
    ...
    thesis: "Find the air loss before production does. One accountable utility event—from abnormal demand to verified compressed-air performance.",
    ...
    response: [
      ...
      { stage: "Verify", product: "Singularity + Infinit-Control", mode: "AUTO", detail: "Compare off-shift flow, pressure, power, specific power, and the complete 30-minute stability window." },
    ],
    ...
    processMap: { src: "/images/reference/manufacturing-compressed-air-condition-to-outcome.png", alt: "Manufacturing compressed-air condition-to-outcome map connecting pressure, flow, power, and production context to repair and verified utility performance" },
  ...
  refrigeration: {
    ...
    thesis: "Protect product, prove recovery. One accountable refrigeration event—from early capacity loss to verified product protection.",
    ...
    response: [
      ...
      { stage: "Verify", product: "Singularity + Infinit-Control", mode: "AUTO", detail: "Require room pull-down, suction and superheat in band, normal fan current and next defrost, product protection, and complete stability." },
    ],
    ...
    processMap: { src: "/images/reference/cold-storage-refrigeration-condition-to-outcome.png", alt: "Cold-storage refrigeration condition-to-outcome map connecting room, product, suction, superheat, fan, and defrost evidence to product protection and verified recovery" },
