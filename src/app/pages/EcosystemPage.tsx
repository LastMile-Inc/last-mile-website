...
const categories = [
  ...
  },
  {
    ...
    copy: "SAP, Maximo, ServiceNow, CMMS, facilities, and related platforms retain their records and lifecycle responsibilities. Last Mile coordinates one operating case and distinguishes record closure from physical recovery.",
  },
  {
...
const handoffs = [
  ...
  ["Optional external work management", "Maximo or ServiceNow", "Approved record creation, status, assignment, and receipt interfaces", "Carries one operating case across the optional system", "Neither is privileged, required, or a platform foundation"],
] as const;
  ...
  return <>
    ...
    <div className="lm-v2-page">
      ...
      <EditorialSection eyebrow="Representative ecosystems" title="Names illustrate where the operating thread crosses—not a privileged architecture.">
        ...
        <p className="lm-v2-caveat">ServiceNow and every other named work system remain optional external systems of record; none is a platform foundation or prerequisite.</p>
