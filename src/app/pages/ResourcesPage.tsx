...
const conceptBriefs = [
  ...
  },
  {
    ...
    copy: "Configured OPC UA, Modbus, BACnet, MQTT, and Sparkplug sources can enter through managed setup files or customer-approved connection methods. Naming a source type does not mean a connection is certified.",
...
const engineeringProofs = [
  {
    ...
    copy: "Sustained rate, bursts, message size, connected-source count, recovery, and offline storage are tested against the exact planned workload.",
    evidence: "Sustained · burst · message size · connected sources · recovery",
    to: "/infinit-signal",
  ...
  },
  {
    ...
    copy: "Customer workspace separation, service identity, encryption, activity records, access rules, and network-aware setup protect access without pretending plant networks are ordinary IT.",
