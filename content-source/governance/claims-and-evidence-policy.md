...
Naming HiveMQ, EMQX, HighByte, Ignition, Siemens, AVEVA, Cognite, SAP, Maximo, ServiceNow, JR Automation, Convergix, or another company is illustrative unless the claims registry records implemented or validated status. Never imply partnership from representative placement.
