...
const routes = [
  ...
  ["/ecosystem", "monthly", "0.7"], ["/resources", "monthly", "0.7"], ["/resources/pmo-implementation-hub", "monthly", "0.7"], ["/about", "monthly", "0.7"], ["/contact", "monthly", "0.8"], ["/signal-to-action", "monthly", "0.7"], ["/company/newsroom", "monthly", "0.6"], ["/privacy", "yearly", "0.2"], ["/terms", "yearly", "0.2"],
];
